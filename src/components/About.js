    ...
    return (
        <div tw="border border-solid p-5 grid grid-rows-1 grid-flow-col gap-4 md:items-start">
            ...
            <div>
                ...
                <p tw="col-span-2 font-serif">Kate is a New York City based web designer and developer with a keen eye for the details. She holds a bachelor's degree in theatrical design, technology, and management from Wagner College, and has recently expanded her skill-set by taking a full-stack web development coding intensive through Trilogy at the University of Arizona. Kate is versed in HTML and CSS, JavaScript, Node.js, Express, MySQL, Mongoose, React, Python, Java, and several other programming languages. Due to her heavy background in design and her recent expansion of web development skills, Kate is an excellent candidate for UI/UX work. She understand the unique ways in which designers communicate and how those designs can be implemented and executed through her training as a coder. Kate is open to work anywhere in the United States and she looks forward to discussing how she can add value to your web development team. </p>
                </div>
        </div>
